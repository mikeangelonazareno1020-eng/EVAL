...
<div id="dashboardContent" style="display:none">
    <div style="min-height: calc(100vh - 200px); padding: 25px 0;">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="mb-1">Department Management</h3>
...
<div class="modal fade" id="viewDepartmentModal" tabindex="-1">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body" id="departmentDetailsBody"></div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-muted mb-0"><strong id="deleteDepartmentName"></strong></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
...
<script src="assets/js/department_management.js"></script>
